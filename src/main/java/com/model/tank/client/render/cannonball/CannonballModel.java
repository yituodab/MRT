...
public class CannonballModel extends GeoModel<CannonballEntity> {
    ...
    public ResourceLocation getModelResource(CannonballEntity cannonballEntity) {
        return new ResourceLocation(ModularTank.MODID, "geo/cannonballs/"+ cannonballEntity.getType().toString().toLowerCase()+".json");
    }

    @Override
    public ResourceLocation getTextureResource(CannonballEntity cannonballEntity) {
        return new ResourceLocation(ModularTank.MODID,"textures/cannonballs/"+ cannonballEntity.getType().toString().toLowerCase()+".png");
    }
